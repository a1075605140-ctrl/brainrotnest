...
import type { Character } from "@/lib/charactersData.pt-br"

export default function CharactersClientPtBr({ characters }: { characters: Character[] }) {
    ...
    <>
      ...
      {filtered.length === 0 ? (
        <p className="text-center py-16 text-lg" style={{ color: "var(--color-text-muted)" }}>
          Nenhum personagem encontrado para &ldquo;{query}&rdquo;
        </p>
      ) : (
